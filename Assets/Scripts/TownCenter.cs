...
public class TownCenter : NetworkBehaviour
{
    ...
    public void Initialize()
    {
        ...
        villagerNames = new string[] {
            "John", "Billy", "Catherine", "David", "Timothy", "Emily",
            "Logan", "Connor", "Kaila", "Abby", "Ryan",
            "Brendan", "Johny", "Trish", "Natalie", "Chris", "Nicole",
            "Elvis", "John", "Ringo", "Rick", "Daphnie", "Rusty", "Eve",
            "Him", "Vlad", "Them", "Peter", "Mary", "Henry", "Mike",
            "Mac", "Dale", "Daisy", "Ajane", "Lilliana", "Trogdor",
            "Brock", "Jeff", "Johny", "Ash", "Ashley", "Tobias", "Tang",
            "Pine", "Colin", "Jamie", "Kai", "Grace", "Ella",
            "Sabrina", "Eli", "See-Mong", "Deneke", "Sydney"
        };
